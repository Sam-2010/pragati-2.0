...
${(() => {
  ...
  if (/new well|navin vihir|farm pond|plastic lining/i.test(s)) return '      - CRITICAL OVERRIDE: Land MUST be Jirayat. Do not trust the top Form 7 summary if it contradicts Form 12. DO NOT attempt to match Khata numbers between Form 7 and Form 12! Look at the MOST RECENT year in Form 12. If it shows ANY "Irrigated" crops or a well ("vhir", "vihir") ANYWHERE, reject it (it is currently Bagayat). Otherwise, pass.';
  if (/old well|juni vihir|boring|pump set|electricity connection/i.test(s)) return '      - CRITICAL OVERRIDE: Land MUST be Bagayat. Do not trust the top Form 7 summary. DO NOT attempt to match Khata numbers between Form 7 and Form 12! Look at the MOST RECENT year in Form 12. If it shows ANY "Irrigated" crops or a well ("vhir", "vihir") ANYWHERE, you MUST consider the entire parcel Bagayat and pass it. Reject ONLY if the most recent year in Form 12 is purely Non-Irrigated.';
